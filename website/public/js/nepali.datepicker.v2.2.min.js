...
function performSelectMonth(t) { showCalendar((ndpAttr.npdYear ? $("#npd-year-select").val() : t) + "-" + $("#npd-month-select").val() + "-01") }

function performSelectYear(t) { showCalendar($("#npd-year-select").val() + "-" + (ndpAttr.npdMonth ? $("#npd-month-select").val() : t) + "-01") }
...
function hideCalendarBox(t) { t = void 0 !== t ? t : !0, $("#ndp-nepali-box").fadeOut(100), npdCalendarVisible = !1, t && ndpAttr.onChange && ndpAttr.onChange() }
